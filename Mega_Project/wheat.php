...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="wholesalernav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="w_wheatfarmer.php">Farmer Booking list</a>
                    </li>
                    <li class="nav-item">
    ...
    $sql2 = "SELECT name, age, mobileNumber, address, type, quantity, rate FROM wholesalerregistration WHERE type = 'Wheat'";
